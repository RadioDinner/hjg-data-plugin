...
// scripts/verify-metrics.ts §31 against a fake PostgREST.
...
export const PAYOUT_BUILD_COLUMN_MIGRATIONS: Readonly<Record<string, string>> = {
  ...
  hour_items: "9961_payout_build_hours.sql",
  hourly_rate: "9961_payout_build_hours.sql",
  hours_pay_total: "9961_payout_build_hours.sql",
};
