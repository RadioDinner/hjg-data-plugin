...
### Where it comes from
- **Seeded once** from the Notion *Mentees Database* (15 selected columns mirrored), linked to the CoachAccountable client by name (\`client_id\`).
...
### What it holds
- Notion **Status**, **Mentor** and **Prayer partner**, **Discovery-call** and **Projected-start** dates, **Freedom-Fight** payment fields, and contact info.
